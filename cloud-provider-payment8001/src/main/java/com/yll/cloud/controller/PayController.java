...
import com.yll.cloud.service.PayService;
...
@RestController
@Slf4j
@Tag(name = "支付微服务模块",description = "支付CRUD")   //swagger注解，服务描述
public class PayController
{
    ...
    public ResultData<Pay> getById(@PathVariable("id") Integer id)
    {
        ...
        //测试超时 暂停xx秒  测试出feign的默认超时时间 默认60秒
        try
        {
    ...
    @Operation(summary = "获取全部",description = "查询全部支付流水方法")
    ...
    public String getInfoByConsul(@Value("${yll.info}") String yll)
    {
        return "yllInfo: "+yll+"\t"+"port: "+port;
    }
